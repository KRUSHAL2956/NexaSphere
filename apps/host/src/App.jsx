...
const DashboardIndex = React.lazy(() => import('adminDashboard/DashboardIndex'));
  ...
  return (
    <main className="gateway-shell">
      <section className="gateway-panel" aria-labelledby="gateway-title">
        ...
        <p>
          The admin dashboard is loaded as a federated remote and isolated behind a circuit-breaker
          boundary.
        </p>
