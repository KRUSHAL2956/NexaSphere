        ...
        this.props.errorFallback ?? (
          <main className="remote-state-shell" role="alert">
            <div className="remote-state-card remote-state-card--error">
              ...
              <p>Keep the admin remote running on port 5001, then refresh this route.</p>
            </div>
          </main>
        )
      );
...
export default function SafeRemoteLoader({ children, fallback = DEFAULT_FALLBACK, errorFallback }) {
  return (
